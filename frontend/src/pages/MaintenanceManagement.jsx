...
const MaintenanceManagement = () => {
  ...
  // Fetch maintenance reports when flat is selected
  useEffect(() => {
    if (selectedFlat) {
  ...
  const handleUpdateStatus = async (e) => {
    ...
    setLoading(true);
    try {
      await axiosInstance.put(`/api/flats/${selectedFlat}/maintenance/${editingReport.id}`, statusForm, {
        headers: { Authorization: `Bearer ${user.token}` }
      });
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      {/* Property Selection - matching your existing form style */}
      ...
      {selectedFlat && (
        <>
          {/* Action Button - matching your existing button styles */}
          <div className="bg-white shadow-md rounded mb-6 p-6">
          ...
          {/* Maintenance Form Modal - matching your existing modal pattern */}
          {showMaintenanceForm && (
                ...
                <form onSubmit={handleReportMaintenance}>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      />
                      {/* Selected Images Preview - matching your FlatForm pattern */}
          ...
          {/* Maintenance Reports List - matching your FlatList design pattern */}
                ...
                {maintenanceReports.map(report => (
                  <div key={report.id} className="border border-gray-200 rounded p-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm mb-3">
                      <div>
                        <span className="font-medium">Contractor:</span> {report.contractorName}
                      </div>
                      <div>
                    ...
                    {/* Images display - matching your FlatList image pattern */}
